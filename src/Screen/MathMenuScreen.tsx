...
const MathMenuScreen: React.FC = () => {
  ...
  // Speak name when index changes
  useEffect(() => {
    const item = menuItems[activeIndex];
    Tts.stop();
    Tts.speak(item.label.toLowerCase());
  }, [activeIndex]);
...
const styles = StyleSheet.create({
  ...
  backBtn: { 
    ...
    backgroundColor: '#FF7043', width: 55, height: 55, 
  ...
  card: { 
    flex: 1,
    borderRadius: 45, borderWidth: 10, 
  ...
  iconCircle: { 
    ...
    borderWidth: 6, borderColor: '#FFF', marginBottom: 20,
    elevation: 5
  },
